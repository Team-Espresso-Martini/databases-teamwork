...
namespace ComputersFactory.Data.MongoDbWriter
{
    ...
    {
        public void GenerateHardDrives(IMongoRepository<HardDriveMongoModel> hardDrivesRepository)
        {
        ...
        public void GenerateMemories(IMongoRepository<MemoryMongoModel> memoriesRepository)
        {
        ...
        public void GenerateMotherboards(IMongoRepository<MotherboardMongoModel> motherboardsRepository)
        {
        ...
        public void GenerateProcessors(IMongoRepository<ProcessorMongoModel> processorsRepository)
        {
        ...
        public void GenerateVideoCards(IMongoRepository<VideoCardMongoModel> videoCardsRepository)
        {
        ...
        public void GenerateComputers(IMongoRepository<HardDriveMongoModel> hardDrivesRepository, IMongoRepository<MemoryMongoModel> memoriesRepository, IMongoRepository<MotherboardMongoModel> motherboardsRepository, IMongoRepository<ProcessorMongoModel> processorsRepository, IMongoRepository<VideoCardMongoModel> videoCardsRepository, IMongoRepository<ComputerShopMongoModel> computerShopsRepository, IMongoRepository<ComputerMongoModel> computersRepository)
        {
            ...
            for (int i = 0; i < computersCount - 1; i++)
            {
                computer = new ComputerMongoModel()
                {
                    ...
                    HardDrives = new HashSet<HardDriveMongoModel>() { hardDrivesCollection[i], hardDrivesCollection[i + 1] }
                };
        ...
        public void GenerateComputerShops(IMongoRepository<ComputerShopMongoModel> computerShopsRepository)
        {
